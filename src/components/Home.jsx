...
const LazyImage = ({ src, alt, className, ...props }) => {
  ...
  return (
    <>
      {!loaded && (
        <div
          className={`${className} bg-gray-800 animate-pulse rounded-lg`}
        ></div>
      )}
      <img
        src={src}
  ...
  <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/90 backdrop-blur-sm">
    <div className="flex flex-col items-center">
      <div className="relative w-20 h-20 mb-4">
        ...
        <div className="absolute inset-2 rounded-full border-4 border-transparent border-b-purple-400 border-l-cyan-300 animate-spin-reverse"></div>
      </div>
      <p className="text-white font-light tracking-wider bg-gradient-to-r from-cyan-300 to-purple-300 bg-clip-text text-transparent">
        Loading Portfolio...
      </p>
    </div>
  </div>
...
const Home = () => {
  ...
  return (
    <>
      ...
      <div
        className={`h-auto relative min-h-auto w-full bg-black overflow-hidden transition-opacity duration-500 ${
      ...
      >
        ...
        <div className="relative min-h-screen flex flex-col justify-between items-center px-6 mt-4 mb-4 z-10">
          <div className="rounded-[70px] w-full h-full p-2 border border-white/20 bg-gradient-to-br from-white/5 to-transparent shadow-2xl shadow-purple-500/10 animate-fadeIn">
            {/* Top header with modern styling */}
            <div className="w-full text-center">
              <h3 className="font-italiana text-white text-sm md:text-base font-extralight tracking-wider bg-gradient-to-r from-white via-blue-100 to-purple-100 bg-clip-text text-transparent animate-slideDown">
            ...
            <div className="h-full flex-1 flex flex-col items-center justify-center w-full max-w-7xl mx-auto">
              ...
              <div className="hidden md:grid grid-cols-1 md:grid-cols-3 gap-[70px] w-full px-4 flex justify-center">
                ...
                <div className="group relative w-60 md:w-80 mt-[300px] z-30 animate-fadeIn delay-100">
                ...
                <div className="relative flex flex-col items-center justify-center z-20 animate-fadeIn delay-200">
                  <div className="mb-[600px] relative text-center mt-3 z-10">
                    <div className="flex items-center justify-center gap-2">
                      ...
                      <h1 className="font-italiana text-5xl md:text-[200px] text-white tracking-wide bg-gradient-to-br from-white via-blue-100 to-purple-200 bg-clip-text text-transparent drop-shadow-2xl animate-textGlow">
                        intersection
                      </h1>
                    </div>
                ...
                <div className="absolute bottom-0 mt-[300px] group relative z-30 animate-fadeIn delay-300">
              ...
              <div className="md:hidden h-full flex flex-col items-center justify-center h-full w-full animate-fadeIn">
                {/* Enhanced Titles */}
