const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/Home-BJO3ENd8.js","assets/index-B2xqom07.js","assets/iconBase-C8_pL4Hr.js","assets/arrow-right-CLG17spm.js","assets/button-17grN15c.css","assets/AboutUs-CArHLfzW.js","assets/4-CdeCWZMT.js","assets/Education-BOEIrg26.js","assets/external-link-LtLWHYg8.js","assets/SkillsData-D7W5mXww.js","assets/proxy-Dg_U9rnX.js","assets/index-Bb0lDp3r.js","assets/boxes-C-B6C7HG.js","assets/ProjectsData-BCdyrMRB.js","assets/1 (19)-Bvkb8K22.js","assets/designpage-C3JwGoy7.js","assets/Testimonials-DjEPrxzA.js","assets/Contact-DvcTubWI.js","assets/Copyright-DcpKSgFQ.js"])))=>i.map(i=>d[i]);
 ...
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const h0=ce.forwardRef(({color:i="currentColor",size:e=24,strokeWidth:n=2,absoluteStrokeWidth:s,className:l="",children:u,iconNode:d,...f},p)=>ce.createElement("svg",{ref:p,...d0,width:e,height:e,stroke:i,strokeWidth:s?Number(n)*24/Number(e):n,className:Gm("lucide",l),...f},[...d.map(([g,w])=>ce.createElement(g,w)),...Array.isArray(u)?u:[u]]));/**
 * @license lucide-react v0.473.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const tn=(i,e)=>{const n=ce.forwardRef(({className:s,...l},u)=>ce.createElement(h0,{ref:u,iconNode:e,className:Gm(`lucide-${c0(i)}`,s),...l}));return n.displayName=`${i}`,n};/**
 * @license lucide-react v0.473.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class oi{constructor(){this.refreshToken=null,this.accessToken=null,this.expirationTime=null}get isExpired(){return!this.expirationTime||Date.now()>this.expirationTime-3e4}updateFromServerResponse(e){de(e.idToken,"internal-error"),de(typeof e.idToken<"u","internal-error"),de(typeof e.refreshToken<"u","internal-error");const n="expiresIn"in e&&typeof e.expiresIn<"u"?Number(e.expiresIn):qp(e.idToken);this.updateTokensAndExpiration(e.idToken,e.refreshToken,n)}updateFromIdToken(e){de(e.length!==0,"internal-error");const n=qp(e);this.updateTokensAndExpiration(e,null,n)}async getToken(e,n=!1){return!n&&this.accessToken&&!this.isExpired?this.accessToken:(de(this.refreshToken,e,"user-token-expired"),this.refreshToken?(await this.refresh(e,this.refreshToken),this.accessToken):null)}clearRefreshToken(){this.refreshToken=null}async refresh(e,n){const{accessToken:s,refreshToken:l,expiresIn:u}=await L1(e,n);this.updateTokensAndExpiration(s,l,Number(u))}updateTokensAndExpiration(e,n,s){this.refreshToken=n||null,this.accessToken=e||null,this.expirationTime=Date.now()+s*1e3}static fromJSON(e,n){const{refreshToken:s,accessToken:l,expirationTime:u}=n,d=new oi;return s&&(de(typeof s=="string","internal-error",{appName:e}),d.refreshToken=s),l&&(de(typeof l=="string","internal-error",{appName:e}),d.accessToken=l),u&&(de(typeof u=="number","internal-error",{appName:e}),d.expirationTime=u),d}toJSON(){return{refreshToken:this.refreshToken,accessToken:this.accessToken,expirationTime:this.expirationTime}}_assign(e){this.accessToken=e.accessToken,this.refreshToken=e.refreshToken,this.expirationTime=e.expirationTime}_clone(){return Object.assign(new oi,this.toJSON())}_performRefresh(){return En("not implemented")}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function K1(i,e){const n=Fc(i,"auth");if(n.isInitialized()){const l=n.getImmediate(),u=n.getOptions();if(kr(u,e??{}))return l;cn(l,"already-initialized")}return n.initialize({options:e})}function Q1(i,e){const n=(e==null?void 0:e.persistence)||[],s=(Array.isArray(n)?n:[n]).map(Sn);e!=null&&e.errorMap&&i._updateErrorMap(e.errorMap),i._initializeWithPersistence(s,e==null?void 0:e.popupRedirectResolver)}function Y1(i,e,n){const s=Ml(i);de(/^https?:\/\//.test(e),s,"invalid-emulator-scheme");const l=!1,u=Ng(e),{host:d,port:f}=X1(e),p=f===null?"":`:${f}`,g={url:`${u}//${d}${p}/`},w=Object.freeze({host:d,port:f,protocol:u.replace(":",""),options:Object.freeze({disableWarnings:l})});if(!s._canInitEmulator){de(s.config.emulator&&s.emulatorConfig,s,"emulator-config-failed"),de(kr(g,s.config.emulator)&&kr(w,s.emulatorConfig),s,"emulator-config-failed");return}s.config.emulator=g,s.emulatorConfig=w,s.settings.appVerificationDisabledForTesting=!0,Ei(d)?(eg(`${u}//${d}${p}`),tg("Auth",!0)):J1()}function Ng(i){const e=i.indexOf(":");return e<0?"":i.substr(0,e+1)}function X1(i){const e=Ng(i),n=/(\/\/)?([^?#/]+)/.exec(i.substr(e.length));if(!n)return{host:"",port:null};const s=n[2].split("@").pop()||"",l=/^(\[[^\]]+\])(:|$)/.exec(s);if(l){const u=l[1];return{host:u,port:Jp(s.substr(u.length+1))}}else{const[u,d]=s.split(":");return{host:u,port:Jp(d)}}}function Jp(i){if(!i)return null;const e=Number(i);return isNaN(e)?null:e}function J1(){function i(){const e=document.createElement("p"),n=e.style;e.innerText="Running in emulator mode. Do not use with production credentials.",n.position="fixed",n.width="100%",n.backgroundColor="#ffffff",n.border=".1em solid #000000",n.color="#b50000",n.bottom="0px",n.left="0px",n.margin="0px",n.zIndex="10000",n.textAlign="center",e.classList.add("firebase-emulator-warning"),document.body.appendChild(e)}typeof console<"u"&&typeof console.info=="function"&&console.info("WARNING: You are using the Auth Emulator, which is intended for local testing only.  Do not use with production credentials."),typeof window<"u"&&typeof document<"u"&&(document.readyState==="loading"?window.addEventListener("DOMContentLoaded",i):i())}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function tE(i,e,n=!1){const{auth:s}=i;if(Qt(s.app))return Promise.reject(Cr(s));const l="reauthenticate";try{const u=await xs(i,Rg(s,l,e,i),n);de(u.idToken,s,"internal-error");const d=Hc(u.idToken);de(d,s,"internal-error");const{sub:f}=d;return de(i.uid===f,s,"user-mismatch"),pi._forOperation(i,l,u)}catch(u){throw(u==null?void 0:u.code)==="auth/user-not-found"&&cn(s,"user-mismatch"),u}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Ug(i,e){return e?Sn(e):(de(i._popupRedirectResolver,i,"argument-error"),i._popupRedirectResolver)}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const BE=new Us(5e3,15e3),HE="__/auth/iframe",VE="emulator/auth/iframe",$E={style:{position:"absolute",top:"-100px",width:"1px",height:"1px"},"aria-hidden":"true",tabindex:"-1"},GE=new Map([["identitytoolkit.googleapis.com","p"],["staging-identitytoolkit.sandbox.googleapis.com","s"],["test-identitytoolkit.sandbox.googleapis.com","t"]]);function qE(i){const e=i.config;de(e.authDomain,i,"auth-domain-config-required");const n=e.emulator?Wc(e,VE):`https://${i.config.authDomain}/${HE}`,s={apiKey:e.apiKey,appName:i.name,v:Ci},l=GE.get(i.config.apiHost);l&&(s.eid=l);const u=i._getFrameworks();return u.length&&(s.fw=u.join(",")),`${n}?${Si(s).slice(1)}`}async function KE(i){const e=await WE(i),n=un().gapi;return de(n,i,"internal-error"),e.open({where:document.body,url:qE(i),messageHandlersFilter:n.iframes.CROSS_ORIGIN_IFRAMES_FILTER,attributes:$E,dontclear:!0},s=>new Promise(async(l,u)=>{await s.restyle({setHideOnLeave:!1});const d=Jt(i,"network-request-failed"),f=un().setTimeout(()=>{u(d)},BE.get());function p(){un().clearTimeout(f),l(s)}s.ping(p).then(p,()=>{u(d)})}))}/**
 * @license
 * Copyright 2020 Google LLC.
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function uS(i){switch(i){case"Node":return"node";case"ReactNative":return"rn";case"Worker":return"webworker";case"Cordova":return"cordova";case"WebExtension":return"web-extension";default:return}}function cS(i){fi(new Ir("auth",(e,{options:n})=>{const s=e.getProvider("app").getImmediate(),l=e.getProvider("heartbeat"),u=e.getProvider("app-check-internal"),{apiKey:d,authDomain:f}=s.options;de(d&&!d.includes(":"),"invalid-api-key",{appName:s.name});const p={apiKey:d,authDomain:f,clientPlatform:i,apiHost:"identitytoolkit.googleapis.com",tokenApiHost:"securetoken.googleapis.com",apiScheme:"https",sdkClientVersion:Tg(i)},g=new H1(s,l,u,p);return Q1(g,n),g},"PUBLIC").setInstantiationMode("EXPLICIT").setInstanceCreatedCallback((e,n,s)=>{e.getProvider("auth-internal").initialize()})),fi(new Ir("auth-internal",e=>{const n=Ml(e.getProvider("auth").getImmediate());return(s=>new aS(s))(n)},"PRIVATE").setInstantiationMode("EXPLICIT")),er(om,lm,uS(i)),er(om,lm,"esm2017")}/**
 * @license
 * Copyright 2021 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 */function xI(i){gS(Ci),fi(new Ir("database",(e,{instanceIdentifier:n})=>{const s=e.getProvider("app").getImmediate(),l=e.getProvider("auth-internal"),u=e.getProvider("app-check-internal");return SI(s,l,u,n)},"PUBLIC").setMultipleInstances(!0)),er(cm,dm,i),er(cm,dm,"esm2017")}kn.prototype.simpleListen=function(i,e){this.sendRequest("q",{p:i},e)};kn.prototype.echo=function(i,e){this.sendRequest("echo",{d:i},e)};xI();const RI={apiKey:"AIzaSyAMDp5WhCZy0tDz-_VcN3bz8HUW2Yp0lw0",authDomain:"personal-portfolio-37a0a.firebaseapp.com",databaseURL:"https://personal-portfolio-37a0a-default-rtdb.firebaseio.com",projectId:"personal-portfolio-37a0a",storageBucket:"personal-portfolio-37a0a.appspot.com",messagingSenderId:"695560029777",appId:"1:695560029777:web:2f666fd6fe7aa39b0c1a70",measurementId:"G-64P0PSRQN5"},X_=lg(RI),PI=pS(X_),oT=TI(X_),lT=new wn,J_=ce.createContext();function bI({children:i}){const[e,n]=ce.useState(null),[s,l]=ce.useState(!0);ce.useEffect(()=>PI.onAuthStateChanged(f=>{n(f),l(!1)}),[]);const u={currentUser:e,isAdmin:(e==null?void 0:e.email)==="e2340065@bit.uom.lk"};return x.jsx(J_.Provider,{value:u,children:!s&&i})}function aT(){return ce.useContext(J_)}var oc,Vm;function AI(){if(Vm)return oc;Vm=1;var i="Expected a function",e=NaN,n="[object Symbol]",s=/^\s+|\s+$/g,l=/^[-+]0x[0-9a-f]+$/i,u=/^0b[01]+$/i,d=/^0o[0-7]+$/i,f=parseInt,p=typeof el=="object"&&el&&el.Object===Object&&el,g=typeof self=="object"&&self&&self.Object===Object&&self,w=p||g||Function("return this")(),_=Object.prototype,y=_.toString,N=Math.max,P=Math.min,U=function(){return w.Date.now()};function z(L,Y,K){var ne,pe,V,M,X,G,we=0,Re=!1,Ee=!1,j=!0;if(typeof L!="function")throw new TypeError(i);Y=me(Y)||0,ye(K)&&(Re=!!K.leading,Ee="maxWait"in K,V=Ee?N(me(K.maxWait)||0,Y):V,j="trailing"in K?!!K.trailing:j);function Z($){var ae=ne,be=pe;return ne=pe=void 0,we=$,M=L.apply(be,ae),M}function W($){return we=$,X=setTimeout(te,Y),Re?Z($):M}function C($){var ae=$-G,be=$-we,ct=Y-ae;return Ee?P(ct,V-be):ct}function R($){var ae=$-G,be=$-we;return G===void 0||ae>=Y||ae<0||Ee&&be>=V}function te(){var $=U();if(R($))return re($);X=setTimeout(te,C($))}function re($){return X=void 0,j&&ne?Z($):(ne=pe=void 0,M)}function he(){X!==void 0&&clearTimeout(X),we=0,ne=G=pe=X=void 0}function fe(){return X===void 0?M:re(U())}function oe(){var $=U(),ae=R($);if(ne=arguments,pe=this,G=$,ae){if(X===void 0)return W(G);if(Ee)return X=setTimeout(te,Y),Z(G)}return X===void 0&&(X=setTimeout(te,Y)),M}return oe.cancel=he,oe.flush=fe,oe}function ke(L,Y,K){var ne=!0,pe=!0;if(typeof L!="function")throw new TypeError(i);return ye(K)&&(ne="leading"in K?!!K.leading:ne,pe="trailing"in K?!!K.trailing:pe),z(L,Y,{leading:ne,maxWait:Y,trailing:pe})}function ye(L){var Y=typeof L;return!!L&&(Y=="object"||Y=="function")}function Ce(L){return!!L&&typeof L=="object"}function H(L){return typeof L=="symbol"||Ce(L)&&y.call(L)==n}function me(L){if(typeof L=="number")return L;if(H(L))return e;if(ye(L)){var Y=typeof L.valueOf=="function"?L.valueOf():L;L=ye(Y)?Y+"":Y}if(typeof L!="string")return L===0?L:+L;L=L.replace(s,"");var K=u.test(L);return K||d.test(L)?f(L.slice(2),K?2:8):l.test(L)?e:+L}return oc=ke,oc}var OI=AI();const DI=Pc(OI),LI="/portfolio_web/assets/28ddd8026ef34e12f9a9c60c864b3e8e-removebg-preview-CGZkUJwy.webp";function MI(){const[i,e]=ce.useState(!1),[n,s]=ce.useState(0),[l,u]=ce.useState("home"),[d,f]=ce.useState(""),[p,g]=ce.useState([]),[w,_]=ce.useState(!1),y=ce.useRef(null),N=ce.useRef(null),P=ce.useRef(null),U=[{icon:x.jsx(w0,{className:"w-4 h-4"}),id:"home",tooltip:"Home"},{icon:x.jsx(O0,{className:"w-4 h-4"}),id:"about",tooltip:"About"},{icon:x.jsx(g0,{className:"w-4 h-4"}),id:"education-journey",tooltip:"Education Journey"},{icon:x.jsx(T0,{className:"w-4 h-4"}),id:"dexterity",tooltip:"Dexterity"},{icon:x.jsx(p0,{className:"w-4 h-4"}),id:"professional-designations",tooltip:"Certifications"},{icon:x.jsx(v0,{className:"w-4 h-4"}),id:"professional-journey",tooltip:"Professional Journey"},{icon:x.jsx(x0,{className:"w-4 h-4"}),id:"creative-ventures",tooltip:"Creative Ventures"},{icon:x.jsx(P0,{className:"w-4 h-4"}),id:"design-scape",tooltip:"Design Scape"},{icon:x.jsx(k0,{className:"w-4 h-4"}),id:"testimonials",tooltip:"Testimonials"},{icon:x.jsx(S0,{className:"w-4 h-4"}),id:"contact",tooltip:"Contact"}];ce.useEffect(()=>{const H=DI(()=>{const me=window.scrollY;s(me);const L=U.map(Y=>document.getElementById(Y.id)).filter(Boolean);for(let Y of L){const K=Y.getBoundingClientRect();if(K.top<=100&&K.bottom>=100){l!==Y.id&&u(Y.id);break}}},200);return window.addEventListener("scroll",H,{passive:!0}),()=>window.removeEventListener("scroll",H)},[l]);const z=(H,me="")=>{const L=document.getElementById(H);if(!L)return;const K=L.getBoundingClientRect().top+window.pageYOffset+-80;window.scrollTo({top:K,behavior:"smooth"}),u(H),me&&ke(L,me)},ke=(H,me)=>{if(!me)return;const L=new RegExp(`(${me})`,"gi");H.querySelectorAll(".search-highlight").forEach(ne=>{const pe=ne.parentNode;pe.replaceChild(document.createTextNode(ne.textContent),ne),pe.normalize()});const Y=document.createTreeWalker(H,NodeFilter.SHOW_TEXT,{acceptNode:ne=>L.test(ne.textContent)?NodeFilter.FILTER_ACCEPT:NodeFilter.FILTER_REJECT}),K=[];for(;Y.nextNode();)K.push(Y.currentNode);K.forEach(ne=>{const pe=document.createDocumentFragment();let V=0,M;for(L.lastIndex=0;M=L.exec(ne.textContent);){const G=ne.textContent.slice(V,M.index);G&&pe.appendChild(document.createTextNode(G));const we=document.createElement("span");we.className="search-highlight bg-yellow-300",we.textContent=M[0],pe.appendChild(we),V=L.lastIndex}const X=ne.textContent.slice(V);X&&pe.appendChild(document.createTextNode(X)),ne.parentNode.replaceChild(pe,ne)}),setTimeout(()=>{H.querySelectorAll(".search-highlight").forEach(ne=>{const pe=ne.parentNode;pe.replaceChild(document.createTextNode(ne.textContent),ne),pe.normalize()})},3e3)},ye=H=>{H.preventDefault();const me=d.trim().toLowerCase();if(!me){g([]),_(!1);return}const L=U.map(({id:Y,tooltip:K})=>{var X;const ne=document.getElementById(Y);if(!ne)return null;const pe=(X=ne.innerText)==null?void 0:X.toLowerCase(),V=pe.indexOf(me);if(V===-1)return null;let M=pe.slice(Math.max(0,V-30),V+me.length+30);return{id:Y,tooltip:K,snippet:M}}).filter(Boolean);g(L),_(!0)};ce.useEffect(()=>{const H=me=>{var L,Y;(L=y.current)!=null&&L.contains(me.target)||_(!1),(Y=N.current)!=null&&Y.contains(me.target)||e(!1)};return document.addEventListener("mousedown",H),()=>document.removeEventListener("mousedown",H)},[]),ce.useEffect(()=>{const H=()=>{window.innerWidth>=768&&e(!1)};return window.addEventListener("resize",H),()=>window.removeEventListener("resize",H)},[]);const Ce=Math.min(n/(document.documentElement.scrollHeight-window.innerHeight)*100,100);return x.jsxs(x.Fragment,{children:[x.jsx("div",{style:{width:`${Ce}%`,height:"2px",background:"linear-gradient(to right, #F97316, #FB923C, #FDBA74)",position:"fixed",top:0,left:0,zIndex:1e3,transition:"width 0.3s ease-in-out",boxShadow:"0 0 10px rgba(249,115,22,0.5)"},role:"progressbar","aria-valuenow":Ce,"aria-valuemin":"0","aria-valuemax":"100","aria-label":"Scroll progress"}),x.jsxs("nav",{ref:P,className:"fixed bottom-4 left-1/2 transform -translate-x-1/2 z-50 bg-gradient-to-r from-black/90 via-black/80 to-black/90 backdrop-blur-xl rounded-full shadow-2xl border border-white/20 px-2 py-1.5 flex items-center space-x-3","aria-label":"Main navigation",children:[x.jsx("button",{onClick:()=>z("home"),className:`p-2 rounded-full transition mr-2 ${l==="home"?"text-white bg-gradient-to-br from-orange-600/80 to-amber-600/40 shadow-lg scale-110":"text-gray-400 hover:text-white hover:bg-white/10"}`,"aria-label":"Home",children:x.jsx("div",{className:"w-6 h-6 rounded-full bg-gradient-to-br from-orange-500 to-amber-500 flex items-center justify-center text-white font-bold text-xs",children:x.jsx("img",{src:$m,alt:"profile",className:" rounded-full"})})}),x.jsx("div",{className:"hidden md:flex items-center space-x-1",children:U.slice(1).map(H=>x.jsx("button",{onClick:()=>z(H.id),className:`relative p-2 rounded-full transition ${l===H.id?"text-white bg-gradient-to-br from-orange-600/80 to-amber-600/40 shadow-lg scale-110":"text-gray-400 hover:text-white hover:bg-white/10"}`,"aria-label":H.tooltip,children:H.icon},H.id))}),x.jsxs("div",{className:"relative md:hidden",children:[x.jsx("button",{onClick:()=>e(!i),className:"p-2 rounded-full text-gray-400 hover:text-white hover:bg-white/10 transition","aria-expanded":i,"aria-controls":"mobile-menu","aria-label":i?"Close menu":"Open menu",children:x.jsxs("div",{className:"w-4 h-3 flex flex-col justify-between",children:[x.jsx("span",{className:`h-0.5 w-full bg-current rounded transition ${i?"rotate-45 translate-y-1":""}`}),x.jsx("span",{className:`h-0.5 w-full bg-current rounded transition ${i?"opacity-0":""}`}),x.jsx("span",{className:`h-0.5 w-full bg-current rounded transition ${i?"-rotate-45 -translate-y-1":""}`})]})}),x.jsx("div",{id:"mobile-menu",ref:N,className:`absolute bottom-full mb-3 left-[1px] w-48 origin-bottom transform transition-all duration-300 bg-black/95 backdrop-blur-xl rounded-xl shadow-2xl overflow-hidden border border-white/20 z-50 ${i?"max-h-96 opacity-100 scale-100":"max-h-0 opacity-0 scale-95 pointer-events-none"}`,children:x.jsxs("div",{className:"p-2 space-y-1",children:[U.slice(1).map(H=>x.jsxs("button",{onClick:()=>{z(H.id),e(!1)},className:`w-full flex items-center space-x-3 px-3 py-2 rounded-lg text-sm transition ${l===H.id?"bg-gradient-to-r from-orange-600/70 to-amber-600/30 text-white":"text-gray-300 hover:bg-white/10 hover:text-white"}`,children:[H.icon,x.jsx("span",{className:"text-xs",children:H.tooltip})]},H.id)),x.jsxs("form",{onSubmit:ye,className:"relative mt-2 flex items-center",role:"search","aria-label":"Website search",children:[x.jsx("input",{type:"search",autoComplete:"off",placeholder:"Search site...",className:"rounded-full px-3 py-1.5 bg-black/70 text-white placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-orange-500 transition text-sm w-full",value:d,onChange:H=>f(H.target.value),onFocus:()=>_(p.length>0)}),x.jsxs("button",{type:"submit",className:"ml-2 px-3 py-1.5 rounded-full bg-orange-500 hover:bg-orange-600 text-white text-sm transition flex items-center justify-center","aria-label":"Submit search",children:[x.jsx(Dp,{className:"w-4 h-4"}),x.jsx("span",{className:"ml-1 hidden sm:inline",children:"Search"})]})]})]})})]}),x.jsxs("form",{onSubmit:ye,className:"relative ml-3 flex items-center",ref:y,role:"search","aria-label":"Website search",children:[x.jsx("input",{type:"search",autoComplete:"off",placeholder:"Search site...",className:`rounded-full px-3 py-1.5 bg-black/70 text-white placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-orange-500 transition text-sm
      ...
      `})]})}const FI="/portfolio_web/assets/bg3-CfJydx4d.webp",UI="/portfolio_web/assets/ChatGPT%20Image%20Nov%204_%202025_%2002_19_47%20PM-BzaaGtyk.webp",jI=ce.lazy(()=>zt(()=>import("./Home-BJO3ENd8.js"),__vite__mapDeps([0,1,2,3,4]))),zI=ce.lazy(()=>zt(()=>import("./videos-CMBm_gjV.js"),[])),WI=ce.lazy(()=>zt(()=>import("./AboutUs-CArHLfzW.js"),__vite__mapDeps([5,6]))),BI=ce.lazy(()=>zt(()=>import("./Education-BOEIrg26.js"),__vite__mapDeps([7,8,3,4]))),HI=ce.lazy(()=>zt(()=>import("./SkillsData-D7W5mXww.js"),__vite__mapDeps([9,10,11,12]))),VI=ce.lazy(()=>zt(()=>import("./LicensesCertifications-BDqXIpWG.js"),[])),$I=ce.lazy(()=>zt(()=>import("./WorkExperience-DpynixIf.js"),[])),GI=ce.lazy(()=>zt(()=>import("./ProjectsData-BCdyrMRB.js"),__vite__mapDeps([13,14,6,12,8]))),qI=ce.lazy(()=>zt(()=>import("./designpage-C3JwGoy7.js"),__vite__mapDeps([15,2,14,10,8,11]))),KI=ce.lazy(()=>zt(()=>import("./Testimonials-DjEPrxzA.js"),__vite__mapDeps([16,4]))),QI=ce.lazy(()=>zt(()=>import("./Contact-DvcTubWI.js"),__vite__mapDeps([17,1,2]))),YI=ce.lazy(()=>zt(()=>import("./Copyright-DcpKSgFQ.js"),__vite__mapDeps([18,10,8,4])));function XI(){const[i,e]=ce.useState(!0),[n,s]=ce.useState(0),[l,u]=ce.useState(!1),[d,f]=ce.useState(!1),p=[UI],w=[{primaryGradient:"from-purple-600 to-blue-600",primaryHoverGradient:"from-purple-500 to-blue-500",secondaryGradient:"from-orange-600 to-red-600",secondaryHoverGradient:"from-orange-500 to-red-500",cardGradient:"from-black/70 via-purple-900/20 to-blue-900/10",cardHoverShadow:"hover:shadow-purple-500/40",cardBorder:"hover:border-purple-400/50",glowEffect:"from-purple-500/20 to-blue-500/15",robotGlow:"from-orange-500/25 via-purple-500/15 to-cyan-500/20",accentColor:"text-cyan-400",badgeGradient:"from-purple-500/30 to-purple-600/20",badgeText:"text-purple-200",badgeBorder:"border-purple-400/40"},{primaryGradient:"from-emerald-600 to-teal-600",primaryHoverGradient:"from-emerald-500 to-teal-500",secondaryGradient:"from-amber-600 to-orange-600",secondaryHoverGradient:"from-amber-500 to-orange-500",cardGradient:"from-black/70 via-emerald-900/20 to-teal-900/10",cardHoverShadow:"hover:shadow-emerald-500/40",cardBorder:"hover:border-emerald-400/50",glowEffect:"from-emerald-500/20 to-teal-500/15",robotGlow:"from-amber-500/25 via-emerald-500/15 to-teal-500/20",accentColor:"text-emerald-400",badgeGradient:"from-emerald-500/30 to-emerald-600/20",badgeText:"text-emerald-200",badgeBorder:"border-emerald-400/40"}][n];return ce.useEffect(()=>{u0.init({duration:600,once:!0});const _=()=>f(window.innerWidth<768);return _(),window.addEventListener("resize",_),()=>{window.removeEventListener("resize",_)}},[]),ce.useEffect(()=>{if(d)return;const _=setInterval(()=>{u(!0),setTimeout(()=>{s(y=>(y+1)%p.length),u(!1)},600)},1e4);return()=>clearInterval(_)},[d,p.length]),ce.useEffect(()=>{if(!sessionStorage.getItem("portfolio_visited")&&!i){const y=setTimeout(()=>{const U=`https://wa.me/94703052181?text=${encodeURIComponent("Someone seeing your Portfolio")}`;sessionStorage.setItem("portfolio_visited","true");const z=window.open(U,"_blank");(!z||z.closed||typeof z.closed>"u")&&console.warn("WhatsApp auto-open was blocked by the browser.")},2500);return()=>clearTimeout(y)}},[i]),x.jsx(bI,{children:i?x.jsx(s0,{onComplete:()=>e(!1)}):x.jsxs("div",{className:"relative bg-black",children:[x.jsxs("div",{className:"fixed inset-0 z-0",children:[x.jsx("img",{src:FI,alt:"background",className:"w-full h-full object-cover opacity-100 blur-[1px]"}),x.jsx("div",{className:"absolute inset-0 bg-gradient-to-t from-black via-purple-900/10 to-cyan-900/5"}),x.jsx("div",{className:"absolute inset-0 bg-gradient-to-br from-transparent via-blue-900/5 to-purple-900/15"})]}),x.jsxs("div",{className:"relative z-10",children:[x.jsx(MI,{}),x.jsxs(ce.Suspense,{fallback:x.jsx("div",{className:"h-screen w-full flex justify-center items-center text-white"}),children:[x.jsxs("main",{children:[x.jsx("section",{id:"home",children:x.jsx(jI,{currentTheme:w,currentRobot:n,isTransitioning:l,robots:p})}),x.jsx("section",{id:"videosection",children:x.jsx(zI,{})}),x.jsx("section",{id:"about",children:x.jsx(WI,{currentTheme:w})}),x.jsx("section",{id:"education-journey",children:x.jsx(BI,{})}),x.jsx("section",{id:"dexterity",children:x.jsx(HI,{currentTheme:w})}),x.jsx("section",{id:"professional-designations",children:x.jsx(VI,{})}),x.jsx("section",{id:"professional-journey",children:x.jsx($I,{})}),x.jsx("section",{id:"creative-ventures",children:x.jsx(GI,{currentTheme:w})}),x.jsx("section",{id:"design-scape",children:x.jsx(qI,{})}),x.jsx("section",{id:"testimonials",children:x.jsx(KI,{})}),x.jsx("section",{id:"contact",children:x.jsx(QI,{currentTheme:w})})]}),x.jsx(YI,{})]})]})]})})}n0.createRoot(document.getElementById("root")).render(x.jsx(ce.StrictMode,{children:x.jsx(XI,{})}));export{v0 as B,S0 as M,P0 as P,JI as R,Dp as S,O0 as U,tT as a,PI as b,tn as c,oT as d,ZI as e,iT as f,nT as g,rT as h,Pc as i,x as j,$m as k,sT as o,lT as p,ce as r,eT as s,aT as u};
